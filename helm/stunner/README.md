...
| `stunnerGatewayOperator.deployment.container.manager.image.tag`                 | The tag for the image.                                           | `1.2.0`                                   |
...
| `stunnerGatewayOperator.dataplane.spec.image.tag`                     | The tag for the image.                                                                                                                               | `1.2.0`                   |
...
| `stunnerAuthService.deployment.container.authService.image.tag`                 | The tag for the image.                                          | `1.2.0`                              |
